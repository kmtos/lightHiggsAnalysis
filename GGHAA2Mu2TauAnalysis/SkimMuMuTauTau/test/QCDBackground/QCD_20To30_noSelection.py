...
mylist=FileUtils.loadListFromFile('/afs/cern.ch/work/m/mshi/private/CMSSW_8_0_17/src/CollectEXO/QCD_20To30_noSelection.txt')
...
process.MuMuTauTauRecoAnalyzer=cms.EDAnalyzer(
        ...
        outFileName=cms.string("QCD_20To30_noSelection.root"),
        ...
        inputFile=cms.string('QCD_20To30_noSelection')
)
