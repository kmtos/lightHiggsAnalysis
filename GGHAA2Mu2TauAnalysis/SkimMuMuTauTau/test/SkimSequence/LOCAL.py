...
process = cms.Process("IM")
mylist = FileUtils.loadListFromFile('FILETESTS/INPUT_FOR_EVENT_COUNT_MiniAOD_SIG_h125a11_MedIsoMu2_TauDMMedIso_APR30.txt')#Debug utils
#Debug utils
