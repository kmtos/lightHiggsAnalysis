...
process.Mu3=cms.EDFilter('VetoMuon',
  muonTag=cms.InputTag('MuonIWant'),
  vetoMuonTag=cms.InputTag('Isolate'),
...
process.muHadTauSelector = cms.EDFilter(
    ...
    overlapCandTag1= cms.InputTag('Isolate'),
...
#sequences
process.IsolateMuMuSequenceSelector=cms.Sequence(
...
process.SelectionSequence = cms.Sequence(process.IsolateMuMuSequenceSelector*
                                           process.PFTau*
                                           process.pfBTagging*
