...
process.Mu50Selector = cms.EDFilter(
    'MuonTriggerObjectFilter',
    recoObjTag = cms.InputTag('PtEtaCut'),
    genParticleTag = cms.InputTag('genParticles'),
    triggerEventTag = cms.untracked.InputTag("hltTriggerSummaryAOD", "", "HLT"),
    triggerResultsTag = cms.untracked.InputTag("TriggerResults", "", "HLT"),
    MatchCut = cms.untracked.double(0.01),
    hltTags = cms.VInputTag(cms.InputTag("HLT_Mu50_v5", "", "HLT")
                            ),
    theRightHLTTag = cms.InputTag("HLT_Mu50_v5","","HLT"),#TTBar background is v2
    #theRightHLTSubFilter1 = cms.InputTag("hltL3fL1sMu16orMu25L1f0L2f10QL3Filtered45e2p1Q","","HLT"),#v2
    theRightHLTSubFilter1 = cms.InputTag("hltL3fL1sMu22Or25L1f0L2f10QL3Filtered50Q","","HLT"),
    HLTSubFilters = cms.untracked.VInputTag(""),
    minNumObjsToPassFilter1= cms.uint32(1),
    outFileName=cms.string("Mu50Selector.root")
)


process.UpsilonTriggerSelector = cms.EDFilter(
    'MuonTriggerObjectFilter',
    recoObjTag = cms.InputTag('Isolate'),
    genParticleTag = cms.InputTag('genParticles'),
    triggerEventTag = cms.untracked.InputTag("hltTriggerSummaryAOD", "", "HLT"),
    triggerResultsTag = cms.untracked.InputTag("TriggerResults", "", "HLT"),
    MatchCut = cms.untracked.double(0.01),
    hltTags = cms.VInputTag(cms.InputTag("HLT_Dimuon13_Upsilon_v26", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v25", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v24", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v23", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v22", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v21", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v20", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v19", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v18", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v17", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v16", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v15", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v14", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v13", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v12", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v11", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v10", "", "HLT"),
                            cms.InputTag("HLT_Dimuon13_Upsilon_v9", "", "HLT"),
    ...
    HLTSubFilters = cms.untracked.VInputTag(""),
    minNumObjsToPassFilter1= cms.uint32(2),
    outFileName=cms.string("UpsilonTriggerSelector.root")
)

process.load('HLTrigger/HLTfilters/hltHighLevel_cfi')
process.IsoMu24eta2p1Selector = process.hltHighLevel.clone()
process.IsoMu24eta2p1Selector.HLTPaths = cms.vstring('HLT_Mu50_v1',
                                                     'HLT_Mu50_v2',
                                                     'HLT_Mu50_v3',
                                                     'HLT_Mu50_v4',
                                                     'HLT_Mu50_v5',
...
#       process.TriggerAnalyzer0*
	...
	process.Mu1Mu2EtaCut*
        process.Isolate*
        process.PtEtaCut*
        process.UpsilonTriggerSelector*
        process.Mu50Selector*
