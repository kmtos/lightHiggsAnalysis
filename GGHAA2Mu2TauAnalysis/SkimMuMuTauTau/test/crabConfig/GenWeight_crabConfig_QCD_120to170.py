...
config.General.requestName = 'QCD_120to170_SignalRegion_SEP4_GenWeights'
...
config.Data.lumiMask = '/afs/cern.ch/user/k/ktos/SkimDir/CMSSW_8_0_17/src/GGHAA2Mu2TauAnalysis/SkimMuMuTauTau/test/crabConfig/crab_projects/crab_QCD_120to170_SignalRegion_SEP4/results/processedLumis.json'
config.Data.outLFNDirBase = '/store/group/phys_higgs/HiggsExo/ktos'
config.Data.publication = True
config.Data.outputDatasetTag = 'QCD_120to170_SignalRegion_SEP4_GenWeights'
