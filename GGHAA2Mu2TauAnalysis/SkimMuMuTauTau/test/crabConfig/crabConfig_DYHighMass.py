...
config.General.requestName = 'MiniAOD_DYHighMass_MedIsoMu2_TauDMAntiMedIso_APR30'
...
config.Data.outputDatasetTag = 'MiniAOD_DYHighMass_MedIsoMu2_TauDMAntiMedIso_APR30'
