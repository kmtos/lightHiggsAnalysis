...
config.General.requestName = 'MiniAOD_DYLowMass_MedIsoMu2_TauDMAntiMedIso_APR30'
...
config.Data.outputDatasetTag = 'MiniAOD_DYLowMass_MedIsoMu2_TauDMAntiMedIso_APR30'
