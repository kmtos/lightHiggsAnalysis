...
config.General.requestName = 'DY_FakeRate_Inv81to101_Mu50_MedMuID_JUL3_F'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../SkimSequence/TestRegionsSkim_Crab_FakeRate_F.py' #_HLT2.py'
...
config.Data.outputDatasetTag = 'DY_FakeRate_Inv81to101_Mu50_MedMuID_JUL3_F'
