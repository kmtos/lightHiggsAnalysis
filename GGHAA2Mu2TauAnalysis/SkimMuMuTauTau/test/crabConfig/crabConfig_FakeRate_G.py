...
config.General.requestName = 'DY_FakeRate_Inv81to101_Mu50_MedMuID_JUL3_G'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../SkimSequence/TestRegionsSkim_Crab_FakeRate_G.py' #_HLT2.py'
...
config.Data.outputDatasetTag = 'DY_FakeRate_Inv81to101_Mu50_MedMuID_JUL3_G'
