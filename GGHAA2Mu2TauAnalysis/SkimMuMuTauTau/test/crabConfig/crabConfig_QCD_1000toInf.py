...
config.General.requestName = 'MiniAOD_QCD_1000toInf_MedIsoMu2_TauDMAntiMedIso_APR30'
...
config.Data.outputDatasetTag = 'MiniAOD_QCD_1000toInf_MedIsoMu2_TauDMAntiMedIso_APR30'
