...
config.General.requestName = 'MiniAOD_QCD_1000toInf_MiniAOD_AntiIsoMu2_TauDMMedIso_JAN1'
...
config.Data.outputDatasetTag = 'MiniAOD_QCD_1000toInf_MiniAOD_AntiIsoMu2_TauDMMedIso_JAN1'
