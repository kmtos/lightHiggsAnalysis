...
config.General.requestName = 'MiniAOD_QCD_300to470_MiniAOD_AntiIsoMu2_TauDMMedIso_JAN1'
...
config.Data.outputDatasetTag = 'MiniAOD_QCD_300to470_MiniAOD_AntiIsoMu2_TauDMMedIso_JAN1'
