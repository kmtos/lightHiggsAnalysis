...
config.General.requestName = 'MiniAOD_ST_tW_NoHadr_antitop_AntiIsoMu2_TauDMMedIso_JAN1'
...
config.Data.outputDatasetTag = 'MiniAOD_ST_tW_NoHadr_antitop_AntiIsoMu2_TauDMMedIso_JAN1'
