...
config.General.requestName = 'MiniAOD_ST_tch_antitop_TuneCUET_AntiIsoMu2_TauDMMedIso_JAN1'
...
config.Data.outputDatasetTag = 'MiniAOD_ST_tch_antitop_TuneCUET_AntiIsoMu2_TauDMMedIso_JAN1'
