...
config.General.requestName = 'MiniAOD_SingleMu1_MedIsoMu2_TauDMAntiMedIso_APR30'
...
config.Data.outputDatasetTag = 'MiniAOD_SingleMu1_MedIsoMu2_TauDMAntiMedIso_APR30'
