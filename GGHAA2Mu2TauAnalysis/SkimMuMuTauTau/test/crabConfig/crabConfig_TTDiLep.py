...
config.General.requestName = 'MiniAOD_TTJetsDiLep_MedIsoMu2_TauDMAntiMedIso_APR30'
...
config.Data.outputDatasetTag = 'MiniAOD_TTJetsDiLep_MedIsoMu2_TauDMAntiMedIso_APR30'
