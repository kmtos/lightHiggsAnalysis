...
config.General.requestName = 'MiniAOD_TTJetsAmca_MedIsoMu2_TauDMAntiMedIso_APR30'
...
config.Data.outputDatasetTag = 'MiniAOD_TTJetsAmca_MedIsoMu2_TauDMAntiMedIso_APR30'
