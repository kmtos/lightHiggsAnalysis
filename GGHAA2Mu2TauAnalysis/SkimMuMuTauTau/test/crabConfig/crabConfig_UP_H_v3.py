...
config.General.requestName = 'Upsilon_Mu51_SignalRegion_SEP18_lumiTree_H_v3'
...
config.Data.inputDataset = '/SingleMuon/Run2016H-23Sep2016-v3/AOD'
...
config.Data.outputDatasetTag = 'Upsilon_Mu51_SignalRegion_SEP18_lumiTree_H_v3'
