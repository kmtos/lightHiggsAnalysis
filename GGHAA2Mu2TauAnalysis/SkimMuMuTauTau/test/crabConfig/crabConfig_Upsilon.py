...
config.General.requestName = 'Upsilon_TestForBadTrigger_APR26'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../SkimSequence/TestRegionsSkim_Crab_Upsilon.py' #_HLT2.py'
...
config.Data.outputDatasetTag = 'Upsilon_TestForBadTrigger_APR26'
