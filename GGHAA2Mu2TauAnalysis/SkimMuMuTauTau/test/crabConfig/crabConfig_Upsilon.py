...
config.General.requestName = 'MiniAOD_Upsilon_MedIsoMu2_TauDMAntiMedIso_APR30'
...
config.Data.outputDatasetTag = 'MiniAOD_Upsilon_MedIsoMu2_TauDMAntiMedIso_APR30'
