...
config.General.requestName = 'Upsilon_Mu50_CJ_NoIsoDiTau_MedMuID_JUN22_G'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../SkimSequence/TestRegionsSkim_Crab_Upsilon_G.py' #_HLT2.py'
...
config.Data.outputDatasetTag = 'Upsilon_Mu50_CJ_NoIsoDiTau_MedMuID_JUN22_G'
