...
process.Mu45Selector = cms.EDFilter("MuonTriggerObjectFilter",
    ...
    theRightHLTTag = cms.InputTag("HLT_Mu45_eta2p1_v3","","HLT"),
...
process.muHadIsoTauSelector = cms.EDFilter("CustomTauSepFromMuonSelector",
    ...
    tauDiscriminatorTags = cms.VInputTag(cms.InputTag("hpsPFTauDiscriminationByDecayModeFindingNewDMs","","SKIM"), cms.InputTag("hpsPFTauDiscriminationByMediumCombinedIsolationDBSumPtCorr3Hits","","SKIM")),
