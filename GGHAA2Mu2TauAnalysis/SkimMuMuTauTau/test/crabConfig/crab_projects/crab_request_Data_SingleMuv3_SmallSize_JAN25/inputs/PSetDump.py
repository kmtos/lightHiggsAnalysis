...
process.muHadNonIsoTauSelector = cms.EDFilter("CustomTauSepFromMuonSelector",
    baseTauTag = cms.InputTag("hpsPFTauProducer","","SKIM"),
    dR = cms.double(0.5),
    etaMax = cms.double(2.4),
    isoMax = cms.double(-1.0),
    ...
    tauDiscriminatorTags = cms.VInputTag(cms.InputTag("hpsPFTauDiscriminationByMediumIsolationMVArun2v1DBnewMwLT","","SKIM")),
    tauHadIsoTag = cms.InputTag("hpsPFTauDiscriminationByCombinedIsolationDeltaBetaCorrRaw3Hits","","SKIM"),
...
process.MuMuSequenceSelector = cms.Sequence(process.MuonIWant+process.HighestPtAndMuonOppositeSignDRSelector+process.Mu1Mu2PtRankMuonID+process.Mu1Mu2EtaCut+process.Isolate+process.PtEtaCut+process.Mu45Selector)
...
process.antiSelectionSequence = cms.Sequence(process.MuMuSequenceSelector+process.PFTau+process.pfBTagging+process.muHadTauSelector+process.muHadNonIsoTauSelector)
