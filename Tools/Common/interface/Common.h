#ifndef Tools_Common_interface_Common_h
#define Tools_Common_interface_Common_h
...
class Common {
 ...
 public:
  ...
  static void sortByPT(std::vector<pat::Muon*>&);
 ...
 private:
  ...
  static bool comparePATMuonPT(pat::Muon*, pat::Muon*);
