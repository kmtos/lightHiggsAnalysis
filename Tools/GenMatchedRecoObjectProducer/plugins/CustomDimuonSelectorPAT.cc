// -*- C++ -*-
//
// Package:    CustomDimuonSelectorPAT
// Class:      CustomDimuonSelectorPAT
// 
/**\class CustomDimuonSelectorPAT CustomDimuonSelectorPAT.cc 
   BoostedTauAnalysis/CustomDimuonSelectorPAT/src/CustomDimuonSelectorPAT.cc
...
// $Id: CustomDimuonSelectorPAT.cc,v 1.4 2012/11/08 16:40:22 yohay Exp $
//
//
...
class CustomDimuonSelectorPAT : public edm::EDFilter {
public:
  explicit CustomDimuonSelectorPAT(const edm::ParameterSet&);
  ~CustomDimuonSelectorPAT();
...
//
CustomDimuonSelectorPAT::CustomDimuonSelectorPAT(const edm::ParameterSet& iConfig) :
...
CustomDimuonSelectorPAT::~CustomDimuonSelectorPAT()
{
...
bool CustomDimuonSelectorPAT::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void 
CustomDimuonSelectorPAT::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
CustomDimuonSelectorPAT::endJob() {
}

// ------------ method called when starting to processes a run  ------------
bool 
CustomDimuonSelectorPAT::beginRun(edm::Run&, edm::EventSetup const&)
{ 
  return true;
}
...
bool 
CustomDimuonSelectorPAT::endRun(edm::Run&, edm::EventSetup const&)
{
  return true;
}
...
bool 
CustomDimuonSelectorPAT::beginLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
  return true;
}
...
bool 
CustomDimuonSelectorPAT::endLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
  return true;
}
...
void
CustomDimuonSelectorPAT::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(CustomDimuonSelectorPAT);
