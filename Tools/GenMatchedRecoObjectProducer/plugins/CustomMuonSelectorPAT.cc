// -*- C++ -*-
//
// Package:    CustomMuonSelectorPAT
// Class:      CustomMuonSelectorPAT
// 
/**\class CustomMuonSelectorPAT CustomMuonSelectorPAT.cc 
   BoostedTauAnalysis/CustomMuonSelectorPAT/src/CustomMuonSelectorPAT.cc
...
// $Id: CustomMuonSelectorPAT.cc,v 1.4 2012/11/08 16:40:22 yohay Exp $
//
//
...
class CustomMuonSelectorPAT : public edm::EDFilter {
public:
  explicit CustomMuonSelectorPAT(const edm::ParameterSet&);
  ~CustomMuonSelectorPAT();
...
//
CustomMuonSelectorPAT::CustomMuonSelectorPAT(const edm::ParameterSet& iConfig) :
...
CustomMuonSelectorPAT::~CustomMuonSelectorPAT()
{
...
bool CustomMuonSelectorPAT::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  else throw cms::Exception("CustomMuonSelectorPAT") << "Error: unsupported muon ID.\n";
...
void 
CustomMuonSelectorPAT::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
CustomMuonSelectorPAT::endJob() {
}

// ------------ method called when starting to processes a run  ------------
bool 
CustomMuonSelectorPAT::beginRun(edm::Run&, edm::EventSetup const&)
{ 
  return true;
}
...
bool 
CustomMuonSelectorPAT::endRun(edm::Run&, edm::EventSetup const&)
{
  return true;
}
...
bool 
CustomMuonSelectorPAT::beginLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
  return true;
}
...
bool 
CustomMuonSelectorPAT::endLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
  return true;
}
...
void
CustomMuonSelectorPAT::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(CustomMuonSelectorPAT);
